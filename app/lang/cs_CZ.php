...
return [
  ...
  'atelierCoDelamePrvniOdstavec' => 'Atelier Plus minus nula nabízí profesionální servis v oblasti projekční a inženýrské činnosti. Pracujeme na projektech různých druhů a měřítek; od návrhů a rekonstrukcí interiérů, výstavnictví, přes drobnou architekturu, až po větší stavby a urbanismus.',
  'atelierCoDelameDruhyOdstavec' => 'Obraťte se na nás i s netradičním zadáním nebo nekonkrétní vizí projektu (investičním záměrem), kterou Vám pomůžeme rozvinout. Jsme tu pro Vás od úvodní konzultace až po spolupráci během realizace. Více o nabízených službách ZDE.',
  ...
  'atelierProcPlusMinusNulaPrvniOdstavec' => 'Atelier PLUS MÍNUS NULA  je výsledkem rozhodnutí pracovat autorsky a samostatně. Spojením různorodých pracovních zkušeností z Česka i zahraničí tvoříme tým se společnou vizí a rozmanitým úhlem pohledu. ',
  'atelierProcPlusMinusNulaDruhyOdstavec' => 'Název PLUS MÍNUS NULA  pro nás znamená přiblížení se dokonalosti i nadhled se smyslem pro humor v někdejším pojmu z pozemního stavitelství. Nula prezentuje dokonalost, které nelze objektivně dosáhnout, proto odchylka <span class="color-text">&plusmn;</span>',
